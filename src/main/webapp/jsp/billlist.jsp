...
<div class="right">
      ...
      <input type="hidden" id="totalPageCount" value="${totalPageCount}"/>
          	...
          	<div id="info" style="border:1px black solid;position:absolute;margin-top:5px;top:0px;left:0px;background-color:white;padding:5px;display:none;">
          		<p><strong>订单编码：</strong><span id="billCode"></span></p>
	            ...
	            <p><strong>供应商：</strong><span id="proName"></span></p>
